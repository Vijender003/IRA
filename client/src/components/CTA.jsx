...
export default function CTA() {
  return (
    <section className="section-padding relative overflow-hidden">
      ...
      />
      <motion.div
        className="absolute w-[300px] h-[300px] rounded-full bg-accent-500/10 blur-[100px]"
      ...
      <div className="relative z-10 container-custom">
        ...
        >
          <span className="inline-block text-accent-400 text-sm font-semibold tracking-widest uppercase mb-6 bg-accent-500/10 border border-accent-500/20 rounded-full px-5 py-2">
            Start Today
          </span>
