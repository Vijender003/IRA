...
const stories = [
  {
    ...
    text: "I had almost given up on my Canada dream after two rejections. IRA International turned it around completely. From a strong SOP to interview prep, they were with me at every step.",
    icon: "🇨🇦",
  ...
  },
  {
    ...
    result: "Scholarship of AUD 15,000",
    text: "IRA helped me find the perfect university that matched my profile AND got me a scholarship. I'm now working in Sydney with a great job.",
    icon: "🇦🇺",
  ...
  },
  {
    ...
    text: "I needed to join the September intake urgently. IRA expedited my entire application and I got my visa in just 14 days. Absolutely life-changing.",
    icon: "🇬🇧",
          ...
          {stories.map((story, i) => (
            ...
            >
              ...
              <div className="relative glass-card rounded-3xl p-8">
                ...
                <div className="inline-flex items-center gap-1.5 bg-accent-500/10 border border-accent-500/20 rounded-full px-3 py-1 mb-4">
