    ...
    <section id="services" className="section-padding relative">
      ...
      <div className="relative z-10 container-custom">
        <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-20">
          <span className="inline-block text-coral text-sm font-semibold tracking-widest uppercase mb-4">What We Offer</span>
                  ...
                  <div className="grid grid-cols-2 gap-3 mb-8">
                    {service.features.map((f, j) => (
                      <div key={j} className="flex items-center gap-2 text-sm text-white/50">
                        <svg className="w-4 h-4 text-coral flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" /></svg>
                        {f}
                      </div>
                    ))}
                  </div>
                  <Link to="/apply" className="inline-flex items-center gap-2 text-sm font-semibold text-primary-500 bg-primary-500/10 border border-primary-500/20 rounded-xl px-5 py-2.5 group-hover:bg-primary-500/20 group-hover:text-primary-400 hover:shadow-[0_0_20px_rgba(15,106,107,0.15)] transition-all">
