      ...
      {visible && (
        ...
        >
          ...
          >
            ...
            <h3 className="text-2xl font-display font-bold text-white mb-3">Wait! Don't Miss Out</h3>
            <p className="text-white/50 text-sm mb-6 leading-relaxed">
              Get a <strong className="text-accent-400">free profile evaluation</strong> worth ₹1,999 and find the best country & university for your profile.
            </p>
